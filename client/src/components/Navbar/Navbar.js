...
export default function AdminNavbar(props) {
  ...
  let secondaryMargin = "30px";
  let paddingX = "15px";

  navbarPosition = "";
  navbarShadow = useColorModeValue("none", "0px 7px 23px rgba(0, 0, 0, 0.05)");
  navbarBg = useColorModeValue(
    "#1A202C",
    "linear-gradient(112.83deg, rgba(255, 255, 255, 0.82) 0%, rgba(255, 255, 255, 0.8) 110.84%)"
  );
  //   navbarBorder = useColorModeValue("rgba(255, 255, 255, 0.31)", "#FFFFFF");
  navbarBorder = useColorModeValue("#1A202C", "#FFFFFF");
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box ms="10px" w={{ sm: "100%", md: "unset" }} display={show}>
          <AdminNavbarLinks
            onOpen={props.onOpen}
